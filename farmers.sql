...
INSERT INTO `farming` (`fid`, `farmingtype`)
VALUES (1, 'Seed Farming'),
  (2, 'coccon'),
  (3, 'silk');
-- --------------------------------------------------------
--
...
INSERT INTO trig
VALUES(null, OLD.rid, 'FARMER DELETED', NOW()) $$ DELIMITER;
DELIMITER $$ CREATE TRIGGER `insertion`
AFTER
INSERT ON `register` FOR EACH ROW
INSERT INTO trig
VALUES(null, NEW.rid, 'Farmer Inserted', NOW()) $$ DELIMITER;
DELIMITER $$ CREATE TRIGGER `updation`
AFTER
UPDATE ON `register` FOR EACH ROW
INSERT INTO trig
VALUES(null, NEW.rid, 'FARMER UPDATED', NOW()) $$ DELIMITER;
-- --------------------------------------------------------
--
...
--
INSERT INTO `trig` (`id`, `fid`, `action`, `timestamp`)
VALUES (1, '2', 'FARMER UPDATED', '2023-01-1 23:04:44'),
  (2, '2', 'FARMER DELETED', '2023-04-1 23:04:58'),
  (3, '8', 'Farmer Inserted', '2023-04-2 23:16:52'),
  (4, '8', 'FARMER UPDATED', '2023-04-2 23:17:17'),
  (5, '8', 'FARMER DELETED', '2023-04-3 23:18:54');
-- --------------------------------------------------------
--
...
VALUES (
    ...
    'arkpro',
    'arkpro@gmail.com',
    'pbkdf2:sha256:150000$TfhDWqOr$d4cf40cc6cbfccbdcd1410f9e155ef2aa660620b0439a60c4d74085dbf007a4a'
  );
--
